...
public class TelaCadastroLocador extends JFrame {
	...
	public TelaCadastroLocador(String[] args) throws Exception {
		...
		panelDadosPessoais
				.setBorder(new TitledBorder(null, prop.getProperty("CadLocadorView.BorderTitle.DadosPessoais"),
		...
		panelEndereco.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)),
				prop.getProperty("CadLocadorView.BorderTitle.Endereco"), TitledBorder.LEADING, TitledBorder.TOP, null,
				new Color(51, 51, 51)));
