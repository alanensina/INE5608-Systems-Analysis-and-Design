--
-- File generated with SQLiteStudio v3.2.1 on ter set 10 00:28:21 2019
--
...
-- Table: endereco
CREATE TABLE endereco (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, logradouro VARCHAR (255), numero VARCHAR (30), complemento VARCHAR (255), bairro VARCHAR (100), cidade VARCHAR (50), estado VARCHAR (10));
